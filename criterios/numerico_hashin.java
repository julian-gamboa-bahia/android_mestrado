...
public class numerico_hashin {
    ...
    numerico_hashin(Context myContext, String lamina_usada, String criterio_usado, String envelope_usado, String endereco)
    {
...
//Outubro11
        ...
        if(sigma_1 > 0)
        {
            if_fibra = (sigma_1/f_SIGMA_T_1)*(sigma_1/f_SIGMA_T_1) + (tau_12/f_TAU12)*(tau_12/f_TAU12);
        }
        else
        {
            if_fibra = sigma_1/f_SIGMA_T_1;
        }
...
//Matriz
        ...
        if(sigma_2 > 0)
        {
            if_matriz = (sigma_2/f_SIGMA_T_2)*(sigma_2/f_SIGMA_T_2) + (tau_12/f_TAU12)*(tau_12/f_TAU12);
        }
        else
        {
            if_matriz =
                    (sigma_2/(2*f_TAU23))*(sigma_2/(2*f_TAU23))
                    + (sigma_2/f_SIGMA_C_2)*(sigma_2/f_SIGMA_C_2)*
                            ((f_SIGMA_C_2/(2*f_TAU23))*(f_SIGMA_C_2/(2*f_TAU23))-1)
                            +
                            (tau_12/f_TAU12)*(tau_12/f_TAU12);
        }
