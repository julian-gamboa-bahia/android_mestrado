...
public class numerico_maxima_tensao {
    ...
    public numerico_maxima_tensao(Context myContext,String lamina_usada, String criterio_usado, String envelope_usado, String endereco)
    {
...
// Vemos o IF na direção local 2
        ...
        Double if_2_t=Math.abs(sigma_2/f_SIGMA_T_2); // Tração
        Double if_2_c=Math.abs(sigma_2/f_SIGMA_C_2); // Compressão
        ...
        Double if_12=Math.abs(tau_12/f_TAU12); //cisalhamento
