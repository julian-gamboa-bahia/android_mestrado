...
public class numerico_azzi_tsai {
    ...
    numerico_azzi_tsai(Context myContext, String lamina_usada, String criterio_usado, String envelope_usado, String endereco)
    {
...
//Procuramos as propriedades da lâmina
        ...
        * */
        ...
        // Colocamos um seletor de propriedades:

        /*
Etapa de seleção conforme o sinal do sigma
*/
        ...
        Double componente_1=(sigma_1/X);
        Double termo_1=componente_1*componente_1;

        Double componente_2=(sigma_2/Z);
        Double termo_2=componente_2*componente_2;

        Double componente_3=(tau_12/f_TAU12);
        Double termo_3=componente_3*componente_3;
//Componente cruzado
        Double componente_12=((sigma_1*sigma_2)/(Y*Y));

        Double somando=termo_1+termo_2+termo_3-componente_12;
//Lembremos que o IF é a raíz quadrada
        //Double if_unico=Math.sqrt(somando);
